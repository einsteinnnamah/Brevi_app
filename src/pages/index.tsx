...
export default function Home() {
  return (
   ...
   <div className="xl:w-[1440px] px-[24px] xl:px-[120px] lg:px-[64px] md:px-[32px] m-auto ">
    ...
    <div className="  text-French-Puce text-[32px] font-bold cursor-pointer">Br<span className="text-Crayola">evi</span></div>
    <Link href="/login"
                      type="button"
    ...
    <div className="flex flex-col gap-5 items-center md:flex-row justify-between mt-[100px]">
      <div>
<h1 className=" text-[32px] lg:text-[42px] lg:w-[350px] font-bold">SImplify Links, Engage with Ease</h1>
<p className=" text-[18px] lg:text-[20px] text-[gray] lg:w-[338px]">Brevi is a simple tool which was built to make URLs as short as possible and boost engagements</p>
<Link href="/signup"
                      type="button"
